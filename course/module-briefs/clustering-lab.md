# Lecture 3: Lab · Compare clustering methods

Status: ready for the approved 2026-09-06 release.

## Source boundary
- materials/labs/Exercise3_clustering.ipynb: Preprocessing, aggregation, and all six clustering sections

## Intended performance
- Explain the notebook’s 3D geographic representation and aggregation.
- Identify parameters for each clustering method.
- Compare runtime and partition behavior without treating the map as ground truth.

Coverage: COV-032, COV-033, COV-034, COV-035
...
- Conceptual hinge: Prepare the GeoNames notebook and compare six methods using a consistent experimental record.
- Learner action: lab-record; then a fresh final challenge.
...
- Transfer: Why can a clustering on 3D coordinates look distorted in the longitude-latitude plot?
